    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 items-center justify-center lg:flex" style={{ background: "var(--gradient-hero)" }}>
        <div className="max-w-md text-center p-12">
          ...
          <p className="mt-4 text-muted-foreground">Create your account and start managing projects in minutes.</p>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-4 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <Button variant="outline" className="mt-6 w-full gap-2 border-border text-foreground hover:bg-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="John Doe" className="pl-10 bg-background border-border" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@example.com" className="pl-10 bg-background border-border" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPw ? "text" : "password"} placeholder="••••••••" className="pl-10 pr-10 bg-background border-border" />
